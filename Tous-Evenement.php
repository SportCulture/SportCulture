...
<head>
    ...
    <title>tous les évènements planifier, Activités de la cité Chlef</title>
...
<nav class="navbar navbar-light fixed-top shadow-lg couleur-h">
          ...
          <div class="offcanvas offcanvas-end couleur-t" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item E">
                  <a class="nav-link active" href="Tous-Evenement.php">Tous les évènements</a>
                </li>
                <li class="nav-item E">
    ...
    <center><h1>Voir tous les évènements planifiés</h1></center>
      
          <ul class="menu-bouton" >
            <li><a class="menu" id="linkM" href="#moderne">plus récents</a></li><br>
            <li><a class="menu" id="linkV" href="#vieux">plus anciens</a></li><br>
             </ul>
    <br>
    <main>
        <div class="cadre">
        ...
        <span id="moderne"></span>
          <?php
            require_once "conectionBDD.php";
            
            $dateCourant= date("Y-m-d");
                $affEV=$database->prepare("SELECT * FROM evenement ORDER BY dateEV DESC");
                $affEV->execute();
                ...
                foreach ($affEV as $toutEV) {
                    ...
                    if($bPartici=='1'){
                        ...
                        if ($pourINSC=='0') {
                            echo  "<P><ins>Participation ouvert à tous les résidents dans l'activité de</ins> <strong>".$actEV."</strong></P>";
