...
<head>
  ...
  <title>Les Activités Scientifique de la Cité Chlef</title>
...
<body>
  ...
  <div>
    <center>
      <h1>Les Activités Scientifique de la Cité Chlef</h1>
    </center>
  </div>
  <br>
  <main>
    <div class="cadre">
      ...
      $apporte = $database->prepare("SELECT * FROM activite WHERE typeA LIKE 'scientifique'");
      $apporte->execute();
